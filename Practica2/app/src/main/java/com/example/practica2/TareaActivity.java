...
public class TareaActivity extends AppCompatActivity {
    ...
    private final int[] fecha = new int[3];
    private final int[] horaInicio = new int[2];
    private final int[] horaFin = new int[2];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Tarea tarea = (Tarea) getIntent().getExtras().get("tarea");
    ...
    public void eliminarTarea(View v) {
        ...
        builderAD.setPositiveButton("Eliminar", (dialogInterface, which) -> eliminarTarea((int) getIntent().getExtras().get("index_calendario")));
