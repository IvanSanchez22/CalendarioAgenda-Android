...
public class ClaseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppCompatSpinner spinner = findViewById(R.id.diaSemanaSpinnerClase);
    ...
    public void eliminarClase(View v) {
        ...
        builderAD.setPositiveButton("Eliminar", (dialogInterface, which) -> eliminarClase((int) getIntent().getExtras().get("index_horario")));
